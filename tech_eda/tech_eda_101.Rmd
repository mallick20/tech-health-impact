...
plots1 <- ggplot(result_users_net, aes(x = hryear4, y = tech_users)) +
  geom_line(size = 1.2) +
  geom_point(size = 2) +
  labs(
...
plots2 <- ggplot(result_income_net, aes(x = hryear4, y = count, color = factor(hefaminc), group = hefaminc)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plots3 <- ggplot(result_gender_net, aes(x = hryear4, y = count, color = factor(pesex), group = pesex)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plots4 <- ggplot(result_age_net, aes(x = hryear4, y = count, color = factor(prtage), group = prtage)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plots5 <- ggplot(result_education_net, aes(x = hryear4, y = count, color = factor(educ_group), group = educ_group)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plots6 <- ggplot(result_users_dev, aes(x = hryear4, y = count)) +
  geom_line(size = 1.2) +
  geom_point(size = 2) +
  labs(
...
plots7 <- ggplot(result_income_dev, aes(x = hryear4, y = count, color = factor(hefaminc), group = hefaminc)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plots8 <- ggplot(result_gender_dev, aes(x = hryear4, y = count, color = factor(pesex), group = pesex)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plots9 <- ggplot(result_age_dev, aes(x = hryear4, y = count, color = factor(prtage), group = prtage)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plots10 <- ggplot(result_education_dev, aes(x = hryear4, y = count, color = factor(educ_group), group = educ_group)) +
  geom_line(size = 1) +
  geom_point(size = 2) +
  labs(
...
plot_list <- list(plots1, plots2, plots3, plots4, plots5, plots6, plots7, plots8, plots9, plots10)
plot_names <- paste0("plot_", 1:10) 

dir.create("plots", showWarnings = FALSE)  # make folder if it doesn't exist
